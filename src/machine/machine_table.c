...
const machine_t machines[] = {
  // clang-format off
    ...
    /* Uses an Intel N8742AH IC programmed with proprietary firmware at 12.5V
    for the keyboard controller. */
    {
        .name = "[OPTi 499] Diversified Technology CAT1015",
        .internal_name = "cat1015",
        .type = MACHINE_TYPE_486,
        .chipset = MACHINE_CHIPSET_OPTI_499,
        .init = machine_at_cat1015_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
       ...
       firmware. */
    {
        ...
        .bus_flags = MACHINE_PS2_AGP, /* AGP is reserved for the internal video */
       ...
       VT82C42N. */
    {
        ...
        .bus_flags = MACHINE_PS2_NOI97, /* Has Asus-proprietary LAN/SCSI slot */
        .flags = MACHINE_IDE_DUAL | MACHINE_SOUND | MACHINE_APM | MACHINE_ACPI | MACHINE_GAMEPORT | MACHINE_USB,
        .ram = {
            .min = 16384,
            .max = 4194304,
